...
docker-compose exec -T index datacube metadata add https://raw.githubusercontent.com/GeoscienceAustralia/dea-config/38fd6486b151dccd617d5cf973fa6278a2a908e8/product_metadata/eo3_sentinel_ard.odc-type.yaml
docker-compose exec -T index datacube product add https://raw.githubusercontent.com/GeoscienceAustralia/dea-config/master/products/baseline_satellite_data/c3/ga_s2am_ard_3.odc-product.yaml
docker-compose exec -T index s3-to-dc --no-sign-request --skip-lineage --stac "s3://dea-public-data/baseline/ga_s2am_ard_3/55/HFA/2023/02/06/20230206T012949/*.stac-item.json" ga_s2am_ard_3
